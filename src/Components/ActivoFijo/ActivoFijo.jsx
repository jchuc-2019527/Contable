                ...
                <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 py-4">
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      type="number"
                      className="form-control"
                      id="depreciacionActual"
                    />
                  </div>
                  <div className="mb-3">
                    <label className="form-label">
                      Caracterìsticas Activo Fijo
                    </label>
                    <input
                      type="number"
                      className="form-control"
                      id="caracteristicasActivoFijo"
                    />
                  </div>
                            ...
                            >
                              <thead className="thead-light">
                                <tr>
                                  ...
                                  <th className="centrado">
                                    Descripciòn Activo Fijo
                                  </th>
                                  <th className="centrado">
                                    Cantidad Activo Fijo
                                  </th>
